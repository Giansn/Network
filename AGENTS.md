...
This project is indexed by GitNexus as **network** (122 symbols, 191 relationships, 8 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/network/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/network/context` | Codebase overview, check index freshness |
| `gitnexus://repo/network/clusters` | All functional areas |
| `gitnexus://repo/network/processes` | All execution flows |
| `gitnexus://repo/network/process/{name}` | Step-by-step execution trace |
